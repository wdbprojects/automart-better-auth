...
const WelcomeComponent = (props: MultiStepFormComponentProps) => {
  ...
  return (
    <div className="mx-auto bg-sidebar rounded-lg mt-4">
      <div className="p-6">
        <div className="flex gap-x-12 justify-between">
          <div className="flex-1">
            <div className="flex items-center mb-4">
              <CircleCheckIcon className="text-green-500 size-6 mr-2" />
        ...
        <div className="flex justify-around items-center">
          ...
          <div className="flex items-center flex-col justify-center space-y-2">
            <ListRestartIcon className="size-6" />
      ...
      <div className="p-6">
        <Button
          ...
          disabled={isPending}
          onClick={nextStep}
          className="uppercase font-medium text-lg flex gap-x-3 w-full text-white"
        >
          {isPending ? (
